...
function FullStack() {
  ...
  useEffect(() => {
    ...
    return (
      ...
      <Helmet>
        <title>
        Full-Stack Developer Course, Mumbai | 100% Placement Guaranteed

        </title>
        <meta name='discription' content='Become an expert coder and secure high-paying jobs with 100% placement guarantee. Build your coding skills with this complete full stack developer course. '/>
        ...
        <main className="relative"> {/* Add positioning context */}
          <div className="mb-spacing4 my-4"> {/* Only affects breadcrumb */}
            ...
            ondownloadsyllabus={scrollTosyllabus}
                 redirectlink = "/it-course-brochures"
