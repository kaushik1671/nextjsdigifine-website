...
function Graduategd() {
  ...
  useEffect(() => {
    import("./data/Graduatedgd/testimonials").then((m) => setTestimonials(m.default));
    import("./data/Graduatedgd/steps").then((m) => setSteps(m.default));
    import("./data/Graduatedgd/faqs").then((m) => setFaqs(m.default));
    import("./data/Graduatedgd/customcontent").then((m)=> setcustomcontent(m.default));
    import("./data/Graduatedgd/customDigifineFeatures").then((m)=>setcustomDigifineFeatures(m.default))
    import("./data/Graduatedgd/customOtherCoursesFeatures").then((m)=>setcustomOtherCoursesFeatures(m.default))
    import("./data/Graduatedgd/customCertificates").then((m)=> setcustomCertificates(m.default))
    import("./data/Graduatedgd/customTabs").then((m)=>setcustomTabs(m.default))
    import("./data/Graduatedgd/customTools").then((m)=>setcustomTools(m.default))
    ...
    return (
      <>
      <Helmet>
        <title>Graphic Design Course, Mumbai | 100% Job Guarantee
        </title>
        <meta name="description" content=' Passionate about design? This graphic design course in Mumbai helps you transform that passion into a profession with 100% guaranteed placements.'/>
      </Helmet>
