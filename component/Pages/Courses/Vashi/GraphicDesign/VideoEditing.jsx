...
import { faqSchema } from './data/VideoEditing/faqSchema'
...
function VideoEditing() {
  ...
  useEffect(() => {
    ...
    return (
      ...
      <Helmet>
      <title>
      Video Editing Course, Navi Mumbai | 100% Job Guarantee
      </title>      
      <meta name='discription' content="Start your video editing career in Navi Mumbai with practical, project-based learning. This course is perfect for beginners who want to create, grow, and get placed."/>
    ...
    {JSON.stringify(faqSchema)}
        ...
        <main className="relative"> {/* Add positioning context */}
          <div className="mb-spacing4 my-4"> {/* Only affects breadcrumb */}
            ...
            redirectlink = "/graphic-design-curriculum"
