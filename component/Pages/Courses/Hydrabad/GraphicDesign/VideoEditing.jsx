...
function VideoEditing() {
  ...
  useEffect(() => {
    import("./data/VideoEditing/testimonials").then((m) => setTestimonials(m.default));
    import("./data/VideoEditing/steps").then((m) => setSteps(m.default));
    import("./data/VideoEditing/faqs").then((m) => setFaqs(m.default));
    import("./data/VideoEditing/customcontent").then((m)=> setcustomcontent(m.default));
    import("./data/VideoEditing/customDigifineFeatures").then((m)=>setcustomDigifineFeatures(m.default))
    import("./data/VideoEditing/customOtherCoursesFeatures").then((m)=>setcustomOtherCoursesFeatures(m.default))
    import("./data/VideoEditing/customCertificates").then((m)=> setcustomCertificates(m.default))
    import("./data/VideoEditing/customTabs").then((m)=>setcustomTabs(m.default))
    import("./data/VideoEditing/customTools").then((m)=>setcustomTools(m.default))
    ...
    return (
      ...
      <Helmet>
        ...
        <meta name='discription' content="Got a story to tell? Learn to bring it alive visually. Our video editing course in Mumbai is beginner-friendly, with hands-on projects & 100% placement guarantee."/>
      </Helmet>
