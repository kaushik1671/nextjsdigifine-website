...
export default function GDSimulation() {
  ...
  return (
    <>
      ...
      <MyComponent 
        type='dm'
        redirectlink="/course-brochures"
        title='Why Digifine for Digital Marketing Simulation'
        subtitlePart1='Why Digifine for' 
