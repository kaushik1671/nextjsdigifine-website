...
//   {
//     title: 'Enroll',
//     description: 'Kickstart your journey by registering for our program!',
//   },
//   {
//     title: 'Get Trained',
//     description: 'Learn from industry experts via hands-on sessions!',
//   },
//   {
//     title: 'Assessments',
//     description: 'Solve real-world problems to test your skills.',
//   },
//   {
//     title: 'Mock Interview',
//     description: 'Practice with interview panels and boost your confidence.',
//   },
//   {
//     title: 'Get Placed',
//     description: 'Secure a job with 100% placement support.',
//   },
// ]
...
function Multimedia() {
  ...
  useEffect(() => {
    import("./data/Multimedia/testimonials").then((m) => setTestimonials(m.default));
    import("./data/Multimedia/steps").then((m) => setSteps(m.default));
    import("./data/Multimedia/faqs").then((m) => setFaqs(m.default));
    import("./data/Multimedia/customcontent").then((m)=> setcustomcontent(m.default));
    import("./data/Multimedia/customDigifineFeatures").then((m)=>setcustomDigifineFeatures(m.default))
    import("./data/Multimedia/customOtherCoursesFeatures").then((m)=>setcustomOtherCoursesFeatures(m.default))
    import("./data/Multimedia/customCertificates").then((m)=> setcustomCertificates(m.default))
    import("./data/Multimedia/customTabs").then((m)=>setcustomTabs(m.default))
    import("./data/Multimedia/customTools").then((m)=>setcustomTools(m.default))
    ...
    return (
      <>
      <Helmet>
        <title>Animation Course, Mumbai | Guaranteed job placements</title>
        <meta name='description' content=' Bring your creative imagination to life. This multimedia & animation course in Mumbai gives you industry-ready skills to start your career with guaranteed placements.'/>
      </Helmet>
        <main className="relative"> {/* Add positioning context */}
          <div className="mb-spacing4 my-4"> {/* Only affects breadcrumb */}
            ...
            appliedText=""
            contactNumber=""
            imageUrl="/images/banner-image/gd/bgd5.webp"
