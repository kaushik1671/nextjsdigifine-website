...
const ReferralHero = ({ 
  ...
  return (
    <section className="relative w-full bg-[#046AED] pt-16 pb-32 px-4 overflow-hidden">
      
      {/* Background Decorative Glow */}
      <div className="absolute top-0 right-0 w-72 h-72 bg-yellow-400 rounded-full mix-blend-overlay filter blur-3xl opacity-20 pointer-events-none"></div>

      <div className="max-w-4xl mx-auto text-center flex flex-col items-center gap-6 relative z-10">
        
        {/* Badge */}
        <div className="px-4 py-1.5 rounded-full border border-white/20 bg-white/10 text-white text-sm font-medium shadow-sm backdrop-blur-md">
          {badgeText}
        </div>
        ...
        <button className="relative group overflow-hidden bg-yellow-400 text-[#046AED] font-bold py-4 px-9 rounded-2xl shadow-xl shadow-yellow-400/30 transition-all duration-300 transform hover:scale-105 active:scale-95">
          ...
          {/* Secondary Liquid Gloss Layer (For rich water shine effect) */}
