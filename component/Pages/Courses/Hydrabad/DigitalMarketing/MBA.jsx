...
function MBA() {
  ...
  useEffect(() => {
    ...
    return (
      ...
      <>
      <Helmet>
        <title>MBA in Digital Marketing, Mumbai | 100% Job Guarantee + Dubai Visit
        </title>
        <meta name="description" content=" India’s 1st MBA in Digital Marketing with a 100% Job Guarantee and an exclusive industry visit to Dubai. Learn directly from industry mentors and master the latest tools to launch your career." />
      </Helmet>
