...
function UIUX() {
    return (
      <>
      <Helmet>
        <title> UI/UX Design Course, Mumbai | 100% guaranteed placements
        </title>
        <meta name='description' content="Become the designer every team wants. Our UI/UX course in Mumbai teaches you to create intuitive, beautiful digital experiences & get 100% placement guarantee."/>
      </Helmet>
        <main className="relative"> {/* Add positioning context */}
          <div className="mb-spacing4 my-4"> {/* Only affects breadcrumb */}
            ...
            appliedText=""
            contactNumber=""
            imageUrl="images/banner-image/gd/bgd1.webp"
