  ...
  const Card = memo(({ title, imageSrc, hoverImageSrc, buttonText, link ,hovericonImageSrc , iconimageSrc , onMouseEnter, onMouseLeave , headline = "India #1 Digital Marketing Course", onClick }) => {
      ...
      <div
        ...
        className={clsx(
          ...
          canHover && [
            ...
            "hover:z-50",
            "hover:bg-[#324865]",
            "bg-[url('/images/card/bg/black.png')]",
            "hover:bg-[url('/images/card/bg/white.png')]",
          ]
        )}
