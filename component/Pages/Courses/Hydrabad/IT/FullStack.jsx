...
function MasterFSDPython() {
  ...
  useEffect(() => {
    import("./data/DataAnalytics/testimonials").then((m) => setTestimonials(m.default));
    import("./data/DataAnalytics/steps").then((m) => setSteps(m.default));
    import("./data/DataAnalytics/faqs").then((m) => setFaqs(m.default));
    import("./data/DataAnalytics/customcontent").then((m)=> setcustomcontent(m.default));
    import("./data/DataAnalytics/customDigifineFeatures").then((m)=>setcustomDigifineFeatures(m.default))
    import("./data/DataAnalytics/customOtherCoursesFeatures").then((m)=>setcustomOtherCoursesFeatures(m.default))
    import("./data/DataAnalytics/customCertificates").then((m)=> setcustomCertificates(m.default))
    import("./data/DataAnalytics/customTabs").then((m)=>setcustomTabs(m.default))
    import("./data/DataAnalytics/customTools").then((m)=>setcustomTools(m.default))
