...
const marqueeBottomLogos = [
  ...
  useEffect(() => {
    ...
    import("./data/AEDMP_Vashi/customCertificates").then((m)=> setcustomCertificates(m.default))
    import('./data/MBAVashi/boxcard').then((m)=>setcategories(m.default))
    import("./data/AEDMP_Vashi/faqs").then((m) => setFaqs(m.default));
  }, []);
