...
export default function DSMLSimulation() {
  ...
  const dataset = [
    {
      ...
      description: "Learn in a work-style environment with live projects, mentorship and daily challenges."
    },
    {
      title: "Complete Data Stack",
      description: "Move from Excel and SQL to Python, dashboards, machine learning and AI tools."
    },
    {
      title: "Portfolio Projects",
      description: "Build evidence across fraud detection, forecasting, recommendation and business analytics."
    },
    {
...
const marqueeBottomLogos = [
  ...
  return (
    <>
      <CourseCard
        title="AI Powered Data Science & Data Analytics "
        highlightText="with Corporate Simulation"
        description="Build job-ready skills in Python, SQL, Pandas, Power BI, Tableau, Machine Learning and Generative AI through hands-on projects, mentorship and practical training."
        emi="Placements"
      ...
      <MyComponent 
        title="What Makes Digifine's AI Powered Data Science & Data Analytics with Corporate Simulation Different "
