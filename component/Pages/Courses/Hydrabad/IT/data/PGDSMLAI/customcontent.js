    ...
    content: [
      {
        ...
        items: [
          ...
          "Filter: Array Sorting, Searching & Filtering Array"
        ]
      }
    ]
  },
    ...
    content: [
      {
        ...
        items: [
          ...
          "Data Types: Measurement Levels, Variation Range"
        ]
      }
    ]
  },
    ...
    content: [
      {
        heading: "Scipy",
        items: [
          "Download, Install & Get Started Plotly",
          "Charts: Heat maps, Error Bars",
          "Types of Charts: Pie Chart, Box Plots, Violin Plots, Gantt Charts",
          "3D Plots: 3D Line Plots, 3D Scatter Plot Plotly, 3D Surface Plots",
          "Dynamic: Interacting with Plots, Adding Buttons, Creating Sliders & Selectors to the plot"
        ]
      }
    ]
  },
    ...
    content: [
      {
        heading: "TensorFlow",
        items: [
          "Introduction, Installation & Get Started",
          "Understanding AI, ML & DL",
          "TensorFlow Basics, Neural Networks",
          "Visualization: Word Embedding, Single Layer Perceptron, Linear Regression",
          "Keras, Distributed Computing, Exporting",
          "Multi-Layer Perceptron Learning, Hidden Layers of Perceptron",
          "Optimizers, Descent Optimization, Forming Graphs",
    ...
    content: [
      {
        ...
        items: [
          ...
          "Advance Stats: Standard Deviation & Percentile",
          "Display: Data Distribution, Scatter, Linear & Multiple Regression",
          "Scale, Train/Test",
          "Grid: Decision Tree, Logistic & Grid Search",
          "Bootstrap Allegation & Cross Validation",
          "Cluster: K-search & K-nearest neighbours",
