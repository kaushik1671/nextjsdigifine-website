const customTabs = [
  {
        ...
        },
        {
          ...
          content: "Digital marketing is one of those domains that requires one to not only learn the theoretical concepts but also prioritize the practical application of these topics. This is exactly why Digifine’s Digital Marketing Diploma Course in Andheri, Mumbai incorporates a 20% theoretical and 80% practical approach. Students learn to put their gained knowledge into practice by working on several challenging assignments, live projects, as well as real-world case studies throughout their Diploma in Digital Marketing.",
          buttons: [
                      { text: "Download Syllabus", onClick: () => {} },
                      { text: "Apply Now", onClick: () => {} }
                    ]
