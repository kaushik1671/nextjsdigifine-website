...
function DSAI() {
  ...
  useEffect(() => {
    ...
    return (
      <>
      <Helmet>
        <title> AI Certification, Navi Mumbai | 100% Job Guarantee
        </title>
<meta name='discription' content=" Stay ahead in Data science & AI by learning top industry skills from experts. Build your tech career with this AI certification and get 100% placement guarantee. "/>
      </Helmet>
