const projects = [
  ...
  "Cross-platform campaign integration"
], },
      {
        ...
        description:"Run ads on Meta, Linkedin, Snapchat and X after studying brand case studies for MamaEarth, Lenskart, Amul, Swiggy and so on",
        skills: ["Data Understanding"],
        additionalSkillsCount: 5,
        ...
        modalTitle: "Additional Skills (5)",
        modalSummary:[
  "Social SEO (Search Optimization)",
  "Short-Form Video Directing",
  "Private Community Ownership",
  "UGC (User-Generated Content) Direction",
  "Trend Synthesis"
], },
]
